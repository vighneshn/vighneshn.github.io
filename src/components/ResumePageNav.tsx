...
// Navigation items for the five buttons - SPECIFIC TO RESUME PAGE
...
interface ResumePageNavProps {
  currentPage: string;
}

const ResumePageNav: React.FC<ResumePageNavProps> = ({ currentPage }) => {
  const navigate = useNavigate();
  
  // Since we're on the Resume page, we want to show all other pages, so no need to filter out current page
